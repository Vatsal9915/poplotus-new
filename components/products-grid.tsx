...
const ourProducts = [
  ...
  {
    id: "chips-peri",
    name: "Peri-Peri Makhana Chips",
    description: "Fiery and zesty Peri-Peri makhana chips that bring the perfect crunch with a spicy kick.",
    image: "/chips_peri.png",
    price: 199,
    weight: "90g",
    tags: ["Spicy", "Bold"],
  ...
  {
    id: "chips-pudina",
    name: "Pudina Makhana Chips",
    description: "Refreshing and tangy pudina makhana chips bursting with cool minty flavor and crunch.",
    image: "/chips_pudina.png",
    price: 219,
    weight: "90g",
    tags: ["Minty", "Fresh"],
    nutritionHighlights: ["Baked", "Low Fat", "High Protein"],
  ...
  {
    id: "chips-tomato",
    name: "Tomato Chilli Makhana Chips",
    description: "Tangy and fiery tomato chilli makhana chips packed with a bold punch of flavor.",
    image: "/chips_tomato.png",
    price: 219,
    weight: "90g",
    tags: ["Zesty", "Spicy"],
    nutritionHighlights: ["Baked", "Low Fat", "High Protein"],
  ...
  {
    id: "chips-truffle",
    name: "Parmesan & Truffle Oil Makhana Chips",
    description: "Luxurious parmesan and truffle oil makhana chips with a rich, earthy aroma and gourmet crunch.",
    image: "/chips_truffle.png",
    price: 219,
    weight: "90g",
  ...
  {
    id: "cookies-butter-100g",
    name: "Butter Makhana Cookies",
    description: "Golden and buttery makhana cookies that melt in your mouth with classic rich flavor.",
    image: "/new_cookies_butter.webp",
    price: 299,
    weight: "100g",
  ...
  {
    id: "cookies-sugarfree-100g",
    name: "Sugarfree Makhana Cookies",
    description: "Deliciously wholesome sugarfree makhana cookies that blend guilt-free sweetness with perfect crunch.",
    image: "/new_cookies_sugarfree.webp",
    price: 349,
    weight: "100g",
    tags: ["Healthy", "Guiltfree"],
